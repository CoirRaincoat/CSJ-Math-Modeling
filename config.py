...
# 菜品成本率（按类别差异化，替代统一45%假设）
# 依据: 餐饮行业通用成本结构
#   荤菜: 食材成本50-65% + 人工能耗5-10% ≈ 60%
#   半荤半素: 食材成本30-45% + 人工能耗5-10% ≈ 45%
#   素菜: 食材成本20-30% + 人工能耗5-10% ≈ 30%
#   主食: 食材成本15-25% + 人工能耗5-10% ≈ 28%
#   其他: 默认45%
# 参考文献: Padovan et al. (2023), BMC Nutrition
